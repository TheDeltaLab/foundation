...
import type { IObservable, IObserver } from '../../base.js';
import { DebugLocation } from '../../debugLocation.js';
import type { BaseObservable } from '../../observables/baseObservable.js';
...
import type { TransactionImpl } from '../../transaction.js';
import { formatValue } from '../consoleObservableLogger.js';
import type { IChangeInformation, IObservableLogger } from '../logging.js';
...
export class DevToolsLogger implements IObservableLogger {
    ...
    private readonly _declarations = new Map<string, IObsDeclaration>();
